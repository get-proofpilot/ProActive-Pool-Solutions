      ...
      <div className="relative bg-[#06b6d4] pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden">
         ...
         <div className="relative max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 text-center lg:text-left z-20">
            ...
            <div className="relative group w-full md:w-auto">
                <Button variant="secondary" size="lg" onClick={() => document.getElementById('quote')?.scrollIntoView({ behavior: 'smooth' })} className="w-full md:w-auto px-10 py-5 text-xl shadow-2xl border-2 border-white/20 hover:bg-white hover:text-[#06b6d4] hover:border-white">
                    Get Your Quote
                </Button>
            </div>
         </div>
