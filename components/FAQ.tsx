    ...
    <section id="faq" className="py-16 md:py-32 bg-white relative z-10">
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
        ...
        <div className="lg:w-5/12 sticky top-0 lg:top-32 bg-white z-20 py-4 lg:py-0">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-heading font-black text-slate-900 mb-6 md:mb-10 leading-[0.9] tracking-tight">
          ...
          {faqs.map((faq, idx) => (
            <div key={idx} className="relative group">
              <button 
                ...
                className={`w-full flex items-center justify-between p-4 md:p-6 md:px-8 text-left font-heading font-black text-lg md:text-2xl transition-all rounded-lg border-[3px] border-slate-900 relative z-10
                  ${openIndex === idx 
